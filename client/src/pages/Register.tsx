...
function Register() {
  ...
  return (
    <div className="relative mt-12 flex flex-col items-center gap-12 px-5">
      {/* <h1 className="mx-10 max-w-[40em] text-center font-nunito text-3xl leading-loose text-defaultblue">
        {" "}
        New user registration is currently at capacity and is undergoing
        maintenance. If you wish to join the waitlist, please contact us at
