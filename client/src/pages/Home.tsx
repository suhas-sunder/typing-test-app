          ...
          <div className="flex w-full flex-col items-center justify-center gap-24 font-nunito text-base font-bold italic leading-7 tracking-wider text-sky-700">
            ...
            <section className="mb-20 mt-16 flex w-full flex-col items-center gap-32 px-10 sm:gap-52 ">
              <div className="flex w-full max-w-[920px] flex-col items-center justify-between gap-20 sm:flex-row-reverse sm:gap-10">
                ...
                <div className="flex flex-col items-center justify-center gap-5 text-center sm:items-start">
                  <h2 className="font-lora text-xl font-bold capitalize lg:text-2xl">
                    Gamify your learning
                  </h2>
                  <p className="flex max-w-[25em] font-lato text-sm font-normal leading-8 lg:text-base">
              ...
              <div className="flex w-full max-w-[920px] flex-col items-center justify-between gap-20 sm:flex-row-reverse sm:gap-10">
                ...
                <div className="flex w-full flex-col items-center justify-center gap-5 text-center sm:items-start">
                  <h2 className="font-lora text-xl font-bold capitalize lg:text-2xl">
                    Achievements
                  </h2>
                  <p className="flex max-w-[25em] font-lato text-sm font-normal leading-8 lg:text-base">
