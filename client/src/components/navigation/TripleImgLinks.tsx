...
function TripleImgLinks({ linkData }: PropType) {
  return (
    <ul className="flex w-full max-w-[1200px]  flex-col items-center justify-evenly gap-10 font-roboto capitalize text-gray-500 sm:scale-100 md:flex-row md:gap-0 ">
