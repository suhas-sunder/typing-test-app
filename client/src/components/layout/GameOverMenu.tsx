...
function GameOverMenu({
  ...
  return (
    <div className="flex flex-col items-center gap-5 text-2xl w-10/12 mb-24 mt-10">
      ...
      <p>Your speed was {stats.wpm} WPM and {stats.cpm} CPM with % accuracy.</p>
      <p>You typed {stats.mistakes + stats.correct} characters with {stats.correct} correct and {stats.mistakes} mistakes.</p>
