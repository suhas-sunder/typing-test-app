  ...
  return (
    <article className="flex-col p-8 font-lora leading-loose tracking-wider text-sky-700">
      ...
      <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
        ...
        passionate English teacher, I'm here to guide you every step of the way,
        ensuring you gain both the typing skills and the English language
        proficiency that will serve you well throughout your life. Let's begin!
      </p>
      ...
      <section>
        ...
        <ul className="mb-4 ml-6 flex list-inside list-disc flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>
            Ring finger on <kbd className="rounded bg-gray-200 p-1">S</kbd>
          </li>
          <li>
            Middle finger on <kbd className="rounded bg-gray-200 p-1">D</kbd>
          </li>
          <li>
      ...
      <section>
        ...
        <ul className="mb-4 ml-6 flex list-inside list-disc flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>
            <strong>Enhanced Productivity:</strong> In both academic and
            professional settings, being able to type efficiently can increase
            your productivity and open up more opportunities for work and
            collaboration.
          </li>
          <li>
            <strong>Better Focus:</strong> Typing can help improve your focus
            and concentration, as it requires coordination and attention to
            detail.
          </li>
          <li>
            <strong>Increased Confidence:</strong> Mastering typing can boost
            your confidence in your computer skills, making you more comfortable
            with technology.
          </li>
        </ul>
      </section>
      <section>
        ...
        <ul className="mb-4 ml-6 flex list-inside list-disc flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>
            <strong>Vase:</strong> A vase is an open container, often used to
      ...
      <section>
        ...
        <ol className="mb-4 ml-6 flex list-inside list-decimal flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>What does the word "zebra" mean?</li>
          <li>Create a sentence using the word "vase".</li>
        </ol>
      </section>
      ...
      <section>
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          abilities and your confidence in using the keyboard.
        </p>
      </section>
