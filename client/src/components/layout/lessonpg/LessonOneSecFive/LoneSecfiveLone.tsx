    ...
    <article className="flex-col p-8 font-lora leading-loose tracking-wider text-sky-700">
      ...
      <section>
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          with precision and grace. Are you ready? Let's get started!
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          school assignments. Typing quickly and accurately can save you time
          and frustration. In the professional world, strong typing skills are
          often a requirement for many jobs, as they can improve productivity
          and efficiency.
        </p>
      </section>
