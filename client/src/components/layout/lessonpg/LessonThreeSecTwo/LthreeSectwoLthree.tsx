  ...
  return (
    <article className="mx-auto flex-col p-8 font-lora leading-loose tracking-wider text-sky-700">
      ...
      <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
        ...
        brackets such as <code>{"{}"}</code>, <code>{"[]"}</code>, and standard
        keys like <code>a, s, d, f, j, k, l</code>. This guide is designed for
        beginners who have never typed before, ensuring you become comfortable
        and proficient with these essential skills. As a passionate English
        teacher, I will also provide brief information about the characters and
        words you'll encounter, enhancing both your typing and English literacy.
      </p>
      ...
      <section className="mb-6">
        ...
        <ul className="mb-4 list-disc pl-6">
          ...
          <li>
            <strong>Elbows at Right Angles:</strong> Your elbows should be bent
            at a 90-degree angle.
          </li>
          <li>
            <strong>Eyes on the Screen:</strong> Keep your eyes on the screen,
            not the keyboard.
          </li>
        </ul>
        ...
        <ul className="mb-4 list-disc pl-6">
          ...
          <li>
            Right hand fingers: Index finger on <code>j</code>, Middle finger on{" "}
            <code>k</code>, Ring finger on <code>l</code>, Pinky on{" "}
            <code>;</code>
          </li>
        ...
        <ul className="mb-4 list-disc pl-6">
          <li>
            ...
            Left curly bracket <code>{"{"}</code>: Press <code>Shift</code> +{" "}
            <code>[</code>. Right curly bracket <code>{"}"}</code>: Press{" "}
          ...
          <li>
            ...
            Left square bracket <code>[</code>: Press the <code>[</code> key
            (right of <code>P</code>). Right square bracket <code>]</code>:
            Press the <code>]</code> key (right of <code>[</code>).
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="mb-4 list-disc pl-6">
          <li>
            ...
            letters and their positions helps you type without looking at the
            keyboard, increasing speed and accuracy.
          </li>
          <li>
            <code>{"{}"}</code>, <code>{"[]"}</code>: Used in various contexts,
            brackets can enclose words, phrases, or other elements, providing
            structure and clarity to your writing.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ol className="mb-4 list-inside list-decimal pl-6">
          ...
          <li>What is the significance of proper posture while typing?</li>
          <li>Name two benefits of learning to type efficiently.</li>
          <li>Why is typing important for improving English literacy?</li>
        </ol>
      </section>
