    ...
    <article className="flex-col p-8 font-lora leading-loose tracking-wider text-sky-700">
      ...
      <section className="mt-8">
        ...
        <ul className="mb-4 ml-6 flex list-inside list-disc flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>
            <strong>L:</strong> The letter "L" is an alphabetic character and
            also represents the Roman numeral for 50. It appears in numerous
            English words, such as "love," "lamp," and "lion."
          </li>
          <li>
            <strong>K:</strong> The letter "K" is an alphabetic character often
            used as an abbreviation for words like "kilo" (meaning one thousand)
            or "kilometer."
          </li>
        </ul>
      </section>
