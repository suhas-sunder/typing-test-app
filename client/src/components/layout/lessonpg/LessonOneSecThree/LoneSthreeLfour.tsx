    ...
    <article className="flex-col p-8 font-lora leading-loose tracking-wider text-sky-700">
      ...
      <section className="mt-8">
        ...
        <ol className="mb-4 ml-6 flex list-inside list-decimal flex-col gap-3 font-lato text-lg leading-loose text-slate-700 ">
          ...
          <li>
            ...
            fingers on the keys S, D, K, and L.
            <ul className="list-disc pl-6">
              <li>
                Your right index finger rests on <strong>S</strong>.
              </li>
              <li>
      ...
      <section className="mt-8">
        ...
        <ol className="mb-4 ml-6 flex list-inside list-decimal flex-col gap-3 font-lato text-lg leading-loose text-slate-700 ">
          <li>
            ...
            <ul className="list-disc pl-6">
              <li>Keep your right index finger on the "S" key.</li>
              <li>
                Gently press down on the "S" key using your right index finger.
              </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-6">
              <li>Move your right ring finger to the "K" key.</li>
              <li>
      ...
      <section className="mt-8">
        ...
        <ul className="mb-4 ml-6 flex list-inside list-disc flex-col gap-3 font-lato text-lg leading-loose text-slate-700 ">
          ...
          <li>
            <strong>D:</strong> The letter "D" is found in words like "dog,"
            "day," and "door."
          </li>
          <li>
          ...
          <li>
            <strong>L:</strong> The letter "L" is found in words like "love,"
            "like," and "laugh."
          </li>
        </ul>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          you'll gradually notice improvement.
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <ol className="mb-4 ml-6 flex list-inside list-decimal flex-col gap-3 font-lato text-lg leading-loose text-slate-700 ">
          ...
          <li>
            Why is consistent practice important for improving typing skills?
          </li>
