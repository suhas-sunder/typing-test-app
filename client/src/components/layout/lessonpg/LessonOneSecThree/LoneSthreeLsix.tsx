    ...
    <article className="flex-col p-8 font-lora leading-loose tracking-wider text-sky-700">
      ...
      <section className="mt-8">
        ...
        <ol className="mb-4 ml-6 flex list-inside list-decimal flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>
            ...
            fingers on the keys A, S, D, J, K, and L.
          </li>
          <li>
            Your right little finger rests on <strong>A</strong>.
          </li>
          <li>
            Your right ring finger rests on <strong>S</strong>.
          </li>
          <li>
            Your right middle finger rests on <strong>D</strong>.
          </li>
          <li>
            Your left index finger rests on <strong>J</strong>.
          </li>
          <li>
            Your left middle finger rests on <strong>K</strong>.
          </li>
          <li>
            Your left little finger rests on <strong>L</strong>.
          </li>
        </ol>
      </section>
      <section className="mt-8">
      ...
      <section className="mt-8">
        ...
        <ul className="mb-4 ml-6 flex list-inside list-disc flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          <li>
            ...
            through instant messaging, emails, or social media.
          </li>
          <li>
      ...
      <section className="mt-8">
        ...
        <ul className="mb-4 ml-6 flex list-inside list-disc flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>
            <strong>S:</strong> You'll find "S" in words like "sun," "smile,"
            and "song."
          </li>
          <li>
            <strong>D:</strong> Words like "dog," "day," and "dance" contain the
            letter "D."
          </li>
          <li>
