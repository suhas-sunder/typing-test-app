export default function LoneSthreeLfive() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <section className="mt-8">
        ...
        <ol className="list-decimal pl-6">
          ...
          <li>
            ...
            fingers on the keys F, S, and K.
          </li>
          <li>
            Your right index finger rests on <strong>F</strong>.
          </li>
          <li>
            Your right middle finger rests on <strong>S</strong>.
          </li>
          <li>
            Your right ring finger rests on <strong>K</strong>.
          </li>
        </ol>
      </section>
      ...
      <section className="mt-8">
        ...
        <ol className="list-decimal pl-6">
          <li>
            ...
            <ul className="list-disc pl-6">
              <li>Keep your right index finger on the "F" key.</li>
              <li>
                Gently press down on the "F" key using your right index finger.
              </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-6">
              <li>Shift your right middle finger to the "S" key.</li>
              <li>
                Press down on the "S" key gently using your right middle finger.
              </li>
              <li>Release the key after pressing it.</li>
            </ul>
          </li>
          <li>
            ...
            <ul className="list-disc pl-6">
              <li>Shift your right ring finger to the "K" key.</li>
              <li>
                Press down on the "K" key gently using your right ring finger.
              </li>
              <li>Release the key after pressing it.</li>
            </ul>
          </li>
      ...
      <section className="mt-8">
        <h3 className="mb-4 text-2xl font-bold">
          Understanding F, S, and K in the English Language
        </h3>
        <p>Let's take a moment to appreciate the characters we're typing:</p>
        <ul className="list-disc pl-6">
          <li>
            <strong>F:</strong> The letter "F" is commonly used in English words
            like "friend," "family," and "fun."
          </li>
          <li>
            <strong>S:</strong> The letter "S" is found in words like "sun,"
            "smile," and "sing."
          </li>
          <li>
            <strong>K:</strong> The letter "K" is frequently used in words like
            "key," "king," and "kind."
          </li>
        </ul>
      </section>
