  ...
  return (
    <article className="flex-col p-8 font-lora leading-loose tracking-wider text-sky-700">
      ...
      <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
        ...
        or a seasoned learner, rest assured that by the end of this session,
        you'll be well on your way to becoming a proficient typist.
      </p>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          letter "n" is like a humble building block, forming the foundation of
          countless words and sentences.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          key, poised to strike with precision.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          taken your first step into the world of typing.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          successive keystroke. As you practice, strive for smoothness and
          efficiency, aiming to minimize hesitation and errors.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          navigating its intricacies. In English, the letter "n" is a workhorse,
          appearing frequently in a multitude of words. From "name" to "never"
          to "new", the letter "n" plays a vital role in shaping our language
          and communication.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ol className="mb-4 ml-6 flex list-inside list-decimal flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>
            <strong>
              Why is it important to minimize errors while typing?
            </strong>
          </li>
          <li>
            <strong>
              How can typing proficiency benefit you in real life and
