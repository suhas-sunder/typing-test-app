  ...
  return (
    <article className="flex-col p-8 font-lora leading-loose tracking-wider text-sky-700">
      ...
      <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
        ...
        through the basics, from understanding the layout of the keyboard to
  ...
  Z X C V B N M`}
      ...
      <section>
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          allowing you to swiftly move to other keys without looking at the
          keyboard.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="mb-4 ml-6 flex list-inside list-disc flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          <li>
            ...
            while your right index finger is responsible for the 'J' key.
          </li>
          <li>
            Touch Typing: Aim to type without looking at the keyboard. Trust
            your muscle memory and the tactile feedback of the keys.
          </li>
          <li>
            Posture: Sit up straight with your feet flat on the floor. Position
            your keyboard so that your arms are bent at a 90-degree angle.
          </li>
          <li>
            Relaxation: Keep your hands and fingers relaxed. Avoid unnecessary
            tension, which can lead to fatigue and errors.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          available to help you improve your speed and accuracy.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          assignment. Additionally, proficient typing skills are often required
          in many professions, making you more marketable in the job market.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          grammar, punctuation, and sentence structure as you type and edit your
          written work.
        </p>
      </section>
      ...
      <section>
        ...
        <ol className="mb-4 ml-6 flex list-inside list-decimal flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>Can you name three benefits of learning to type?</li>
