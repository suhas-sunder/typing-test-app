      ...
      <div className="flex flex-col gap-4 pl-2">
        ...
        <ol className="mb-4 ml-6 flex list-inside list-decimal flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>
            ...
            the keys A, S, D, and F. Place your right hand fingers on the keys
            J, K, L, and ; (semicolon).
        ...
        <ul className="mb-4 ml-6 flex list-inside list-disc flex-col gap-3 font-lato text-lg leading-loose text-slate-700">
          ...
          <li>
            <strong>Practice Regularly:</strong> The more you practice, the
            better you will get. Even a few minutes each day can help.
          </li>
          <li>
            <strong>Stay Relaxed:</strong> Keep your hands and fingers relaxed
            to avoid fatigue.
          </li>
        </ul>
        ...
        <p className="mb-4 pl-3 font-lato text-lg leading-loose text-slate-700">
          ...
          be patient with yourself and keep practicing. Once you're comfortable
          with "a" and "s," we can move on to other letters and more advanced
          typing techniques.
        </p>
      </div>
    </article>
