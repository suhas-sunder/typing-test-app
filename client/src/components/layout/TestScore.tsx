...
function TestScore() {
  return (
    <div className="mb-2 flex w-full scale-90 items-center justify-evenly flex-col gap-10 sm:flex-row">
      <div className="flex min-w-[17em] flex-col gap-2 rounded-md border-2 border-yellow-400 p-6 py-4 text-lg">
        <span className="flex items-center justify-center gap-1 border-b-2 border-yellow-400 pb-2">
          ...
          <Icon
            ...
            icon="starFull"
          />
          <Icon title="star-icon" customStyle="inline-flex text-yellow-400" icon="starEmpty" />
          <Icon title="star-icon" customStyle="inline-flex text-yellow-400" icon="starEmpty" />
        </span>
