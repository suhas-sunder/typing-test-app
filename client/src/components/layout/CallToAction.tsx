...
function CallToAction() {
  ...
  return (
    <section className="flex w-full flex-col items-center gap-16 bg-defaultblue py-24 sm:py-16 ">
      <div className="flex w-full max-w-[1200px] flex-col items-center justify-around gap-12 px-5 capitalize text-white md:flex-row tracking-widest leading-6">
      ...
      <Link
        to="/register"
        className={`relative mx-auto inline-flex rounded-full border-[2.5px] border-sky-700 bg-sky-700 px-8 py-3 font-nunito text-xl font-normal text-white hover:scale-[1.02] hover:brightness-105 tracking-wide`}
      >
        Sign Up Free!
      </Link>
    </section>
