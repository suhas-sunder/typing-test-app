...
export function CurriculumUnitPage({ unitId }: { unitId: CurriculumUnitId }) {
  ...
  return (
    <>
      ...
      <nav className="section-pad py-10" aria-label="Lesson units"><div className="page-shell flex flex-wrap justify-between gap-5">{previous ? <Link className="font-black text-camp-coral underline decoration-2 underline-offset-4 hover:text-camp-orange focus-visible:bg-camp-orange focus-visible:text-camp-accent-contrast" href={previous.route}>← {previous.title}</Link> : <Link className="font-black text-camp-coral underline decoration-2 underline-offset-4" href="/lessons">← All lessons</Link>}{next ? <Link className="font-black text-camp-coral underline decoration-2 underline-offset-4 hover:text-camp-orange focus-visible:bg-camp-orange focus-visible:text-camp-accent-contrast" href={next.route}>{next.title} →</Link> : <Link className="font-black text-camp-coral underline decoration-2 underline-offset-4" href="/typing-practice">Focused practice →</Link>}</div></nav>
    </>
  );
}
