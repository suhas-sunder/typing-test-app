...
router.get("/best-stats", async (req: Request, res: Response) => {
  try {
    ...
    const bestWPM = {
      ...
      createdAt: bestWPMStats?.rows[0]?.created_at.toISOString() || null,
    ...
    const bestScore = {
      ...
      createdAt: bestScoreStats?.rows[0]?.created_at.toISOString() || null,
    ...
    const bestTime = {
      ...
      createdAt: bestTimeStats?.rows[0]?.created_at.toISOString() || null,
    ...
    const bestWords = {
      ...
      createdAt: bestWordsStats?.rows[0]?.created_at.toISOString() || null,
