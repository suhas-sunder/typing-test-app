...
export const metadata: Metadata = {
  ...
  description:
    "Choose focused practice for keyboard rows, individual hands, quotes, common words, numbers, and symbols.",
  alternates: { canonical: "/typing-practice" },
  openGraph: {
    title: "Focused Typing Practice | FreeTypingCamp",
    description:
      "Short, medium, and long typing practice for specific keyboard skills.",
    url: "/typing-practice",
    type: "website",
  },
};
    ...
    <PageFrame routeFamily="practice_hub">
      <section className="section-pad">
        <div className="page-shell max-w-4xl">
          <p className="eyebrow">Practice by skill</p>
          <h1 className="heading-lg mt-2">
            Focused typing practice without a noisy dashboard.
          </h1>
          <p className="body-lg mt-4">
            Choose the row, hand, or text type that needs attention. Each
            completed attempt stays in this browser, with a local best compared
            only against the same setup.
          </p>
        </div>
      </section>
      ...
      <section className="bg-camp-tan/45 py-12">
        <div className="page-shell max-w-3xl">
          <p className="eyebrow">Lessons and tests</p>
          <h2 className="heading-md mt-2">Use the right tool for the job</h2>
          <p className="mt-4 leading-7 text-camp-muted">
            Focused practice repeats one skill and does not award lesson stars.
            Use the{" "}
            <Link
              className="font-black text-camp-coral underline underline-offset-4"
              href="/lessons"
            >
              45-lesson curriculum
            </Link>{" "}
            for structured progression, or take the{" "}
            <Link
              className="font-black text-camp-coral underline underline-offset-4"
              href="/typing-test"
            >
